...
func makeError(major, minor C.OM_uint32) *Error {
	return &Error{
...
func StashLastStatus(major, minor C.OM_uint32) error {
	lastStatus := makeError(major, minor)
	return lastStatus.GoError()
}
